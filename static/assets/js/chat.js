...
$(document).ready(function(){
    ...
    socket.on( 'message_received', function( data ){
        ...
        if (data.is_img == true){  // If message is sent, instead of writing URL, write image
            nice_message = "Image"
            img_or_message = '<div class="chat-content" style="width:20%"><a href="'+$("input#static_url").val()+'/'+data.message+'" target="_blank"><img src="'+$("input#static_url").val()+'/downloads/image_icon.png" width="100%"></a></div>'
        }
